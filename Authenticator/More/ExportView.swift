...
struct ExportView: View {
    ...
    private func txtFile() -> URL {
        let txtFileName = "2FA-accounts-" + Date.currentDateText + ".txt"
    ...
    private func zipFile() -> URL {
        let imagesDirectoryName = "2FA-accounts-" + Date.currentDateText
        ...
        let zipFileUrl = URL.tmpDirectoryUrl.appendingPathComponent(zipFileName, isDirectory: false)
